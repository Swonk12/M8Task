...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Botón para abrir la segunda actividad (Conversor)
        Button btnGoToConverter = findViewById(R.id.button);
        btnGoToConverter.setOnClickListener(v -> {
    ...
    private void setOperatorButtonClickListener() {
        ...
        findViewById(R.id.Modulo).setOnClickListener(operatorListener);
        ...
        findViewById(R.id.Potencia).setOnClickListener(v -> {
            if (!currentInput.isEmpty()) {
                firstNumber = Double.parseDouble(currentInput);
